...
/**
 * lovers_images module configuration.
 *
 ...
 */
abstract class BaseLovers_imagesGeneratorHelper extends sfModelGeneratorHelper
{
  public function getUrlForAction($action)
  {
    return 'list' == $action ? 'lovers_images' : 'lovers_images_'.$action;
  }
