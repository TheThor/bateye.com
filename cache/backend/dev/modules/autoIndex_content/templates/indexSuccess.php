...
<?php #include_partial('index_content/navbar', array('filter' => )) ?>
  ...
  <div class="page-header">
    ...
    <h1><?php echo __('Index content List', array(), 'messages') ?>
  ...
  <?php include_partial('index_content/list_header', array('pager' => $pager)) ?>

    <?php include_partial('index_content/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>

  <div id="sf_admin_footer">
    <?php include_partial('index_content/list_footer', array('pager' => $pager)) ?>
  </div>
