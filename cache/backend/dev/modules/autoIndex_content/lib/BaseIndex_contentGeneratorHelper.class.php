...
/**
 * index_content module configuration.
 *
 ...
 */
abstract class BaseIndex_contentGeneratorHelper extends sfModelGeneratorHelper
{
  public function getUrlForAction($action)
  {
    return 'list' == $action ? 'index_content' : 'index_content_'.$action;
  }
