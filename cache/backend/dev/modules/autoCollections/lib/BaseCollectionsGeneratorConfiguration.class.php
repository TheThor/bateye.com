 ...
 */
abstract class BaseCollectionsGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return array(  0 => 'id',  1 => 'name',  2 => 'is_active',  3 => 'created_at',  4 => 'updated_at',);
  }
