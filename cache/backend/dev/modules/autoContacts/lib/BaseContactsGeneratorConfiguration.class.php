 ...
 */
abstract class BaseContactsGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%email%% - %%phone%% - %%created_at%% - %%updated_at%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'email',  2 => 'phone',  3 => 'created_at',  4 => 'updated_at',);
  }
