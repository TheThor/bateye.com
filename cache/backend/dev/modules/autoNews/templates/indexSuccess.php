...
<?php #include_partial('news/navbar', array('filter' => 1)) ?>

      <?php $filterValues = $sf_user->getRawValue()->getAttribute('news.filters', array(), 'admin_module'); if (!empty($filterValues)): ?>
    <div class="alert alert-info alert-block">
      ...
      <?php echo link_to(__('Reset', array(), 'sf_admin'), 'news_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn btn-xs btn-default')) ?>
    </div>
    <?php endif; ?>
  ...
  <div class="page-header">
    ...
    <h1><?php echo __('News List', array(), 'messages') ?>
