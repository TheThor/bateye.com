...
<?php #include_partial('products/navbar', array('filter' => 1)) ?>

      <?php $filterValues = $sf_user->getRawValue()->getAttribute('products.filters', array(), 'admin_module'); if (!empty($filterValues)): ?>
    <div class="alert alert-info alert-block">
      ...
      <?php echo link_to(__('Reset', array(), 'sf_admin'), 'products_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn btn-xs btn-default')) ?>
    </div>
    <?php endif; ?>
  ...
  <div class="page-header">
    ...
    <h1><?php echo __('Products List', array(), 'messages') ?>
