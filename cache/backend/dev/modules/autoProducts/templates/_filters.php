...
<div class="col-md-12"> <!--sf_admin filter what size???-->
	...
	<form role="form" action="<?php echo url_for('products_collection', array('action' => 'filter')) ?>" method="post">
		<div>
		...
		<div>
			...
			<?php echo link_to(__('Reset', array(), 'sf_admin'), 'products_collection',
