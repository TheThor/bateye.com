...
<div id="filterPopup" class="modal fade">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?php echo url_for('products_collection', array('action' => 'filter')) ?>" method="post" class="form-horizontal">
        ...
        <div class="modal-footer">
          ...
          <?php echo link_to(__('Reset', array(), 'sf_admin'), 'products_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn btn-default')) ?>
        </div>
