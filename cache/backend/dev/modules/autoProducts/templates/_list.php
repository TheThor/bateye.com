    ...
    <table class="table table-striped">
      <thead>
        <tr>
          ...
          <?php include_partial('products/list_th', array('sort' => $sort)) ?>
      ...
      <tbody>
        <?php foreach ($pager->getResults() as $products): ?>
          <tr>
            <?php include_partial('products/list_td_batch_actions', array('products' => $products, 'helper' => $helper)) ?>
            <?php include_partial('products/list_td', array('products' => $products)) ?>
