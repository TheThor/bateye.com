...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array(
	'level' => 'debug',
	'file' => '/var/www/bateye/log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
...
if (sfConfig::get('sf_i18n')) {
	...
	$cache = new sfFileCache(array(
		...
		'cache_dir' => '/var/www/bateye/cache/backend/dev/i18n',
		'lifetime' => 31556926,
		'prefix' => '/var/www/bateye/apps/backend/i18n',
	));
...
if (sfConfig::get('sf_cache')) {
	...
	$cache = new $class(sfConfig::get('sf_factory_view_cache_parameters', array(
		'automatic_cleaning_factor' => 0,
		'cache_dir' => '/var/www/bateye/cache/backend/dev/template',
		'lifetime' => 86400,
		'prefix' => '/var/www/bateye/apps/backend/template',
	)));
