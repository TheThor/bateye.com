    ...
    foreach ($categories as $category):
        ...
        <div style="margin: 0 auto; width: 1016px;">
                ...
                foreach ($products as $product):
                    ...
                    ?>
                    <div class="img" data-name="<?php echo $product->getName() ?>" data-category="<?php echo $product->getCategory()->getName() ?>" data-collection="<?php echo $product->getCollection()->getName() ?>">
                        <a href="
                            <?php
                                echo url_for(
                                    array(
