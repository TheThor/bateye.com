...
<div class="container">
    ...
    <?php foreach ($collections as $collection): ?>
        <img id="<?php echo 'collection-image-' . $collection->getId()  ?>" class="collection-image" src="<?php echo '/images/' . strtolower(str_replace(" ", "", $collection->getName())) . '_branco.jpg '?>" style="<?php echo !$display ? 'display:none':'display:block' ?>;">
    <?php $display = false ?>
    <?php endforeach; ?>
    </div>
        <div id="link-container" class="span4">
            ...
            foreach ($collections as $collection):
                ...
                <div class="collection-link" >
                    ...
                    echo link_to(
                        image_tag(
                            'http://dummyimage.com/350x70/ff7f7f/ffffff.png&text=Collection',
