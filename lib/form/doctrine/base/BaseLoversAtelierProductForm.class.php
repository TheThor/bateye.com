...
/**
 * LoversAtelierProduct form base class.
 *
 * @method LoversAtelierProduct getObject() Returns the current form's model object
 *
 * @package    bateye
 * @subpackage form
 ...
 */
abstract class BaseLoversAtelierProductForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lovers_atelier_product[%s]');
