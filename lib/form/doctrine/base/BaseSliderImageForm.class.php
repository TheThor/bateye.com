...
/**
 * SliderImage form base class.
 *
 * @method SliderImage getObject() Returns the current form's model object
 *
 * @package    bateye
 * @subpackage form
 ...
 */
abstract class BaseSliderImageForm extends BaseFormDoctrine
{
