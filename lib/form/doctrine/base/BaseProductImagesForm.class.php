...
/**
 * ProductImages form base class.
 *
 * @method ProductImages getObject() Returns the current form's model object
 *
 * @package    bateye
 * @subpackage form
 ...
 */
abstract class BaseProductImagesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_images[%s]');
