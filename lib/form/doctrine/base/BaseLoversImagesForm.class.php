...
/**
 * LoversImages form base class.
 *
 * @method LoversImages getObject() Returns the current form's model object
 *
 * @package    bateye
 * @subpackage form
 ...
 */
abstract class BaseLoversImagesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lovers_images[%s]');
