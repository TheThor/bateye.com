...
/**
 * PressCatalogue filter form base class.
 *
 * @package    bateye
 * @subpackage filter
 ...
 */
abstract class BasePressCatalogueFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('press_catalogue_filters[%s]');
