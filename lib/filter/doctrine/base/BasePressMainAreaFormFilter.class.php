...
/**
 * PressMainArea filter form base class.
 *
 * @package    bateye
 * @subpackage filter
 ...
 */
abstract class BasePressMainAreaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('press_main_area_filters[%s]');
