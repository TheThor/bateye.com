...
/**
 * PressProductConcept filter form base class.
 *
 * @package    bateye
 * @subpackage filter
 ...
 */
abstract class BasePressProductConceptFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('press_product_concept_filters[%s]');
