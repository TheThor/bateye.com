 ...
 * @property PressCollection $PressCollection
 ...
 * @method PressCollection   getPressCollection() Returns the current record's "PressCollection" value
 ...
 * @method PressProductImage setPressCollection() Sets the current record's "PressCollection" value
...
abstract class BasePressProductImage extends sfDoctrineRecord
{
    ...
    {
        parent::setUp();
        $this->hasOne('PressCollection', array(
             'local' => 'collection_id',
             'foreign' => 'id'));
