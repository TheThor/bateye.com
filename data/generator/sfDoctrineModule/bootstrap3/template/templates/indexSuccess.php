...
<div id="container">
	...
	<?php if ($this->configuration->hasFilterForm()): ?>
		<div class="col-md-3"> <!--sf_admin_bar-->
			[?php include_partial('<?php echo $this->getModuleName() ?>/filters', array('form' => $filters,
	...
	<div id="sf_admin_content">
		...
		<form
			...
			<ul class="sf_admin_actions">
				[?php include_partial('<?php echo $this->getModuleName() ?>/list_batch_actions', array('helper' =>
				$helper)) ?]
